...
function markup(start, end) {
    ...
    $('#leftcontrols').append('<div id="text-controls" class="btn-group pull-right" style="display:none;"><button class="btn btn-sm btn-default" id="textctrl-bold" title="ЖЫРНЫИ" onclick="javascript:markup(\'**\', \'**\')">B</button><button class="btn btn-sm btn-default" id="textctrl-code" title="КОДЕ" onclick="javascript:markup(\'`\', \'`\')">&lt;&gt;</button><button class="btn btn-sm btn-default" style="font-style: italic;" id="textctrl-italic" title="ИТАЛИЯ" onclick="javascript:markup(\'//\', \'//\')">I</button><button class="btn btn-sm btn-default" id="textctrl-strike" title="ЗАЧОКНУТЫЙ" onclick="javascript:markup(\'~~\', \'~~\')">S</button><button class="btn btn-sm btn-default" id="textctrl-spoiler" title="СПОИЛЕР" onclick="javascript:markup(\'[sp]\', \'[/sp]\')">[]</button></div>');
...
var imgurUpload = function() {
    if ($("#uploadbtn").length == 0)
        $("#leftcontrols").append('<button id="uploadbtn" class="btn btn-sm btn-default" title="ЗАГРУСТИТЬ КАРТИНУ" data-toggle="modal" data-target="#imgupload"><span class="glyphicon glyphicon-uploadbtn"></span></button>');
    $("body").append('<div class="modal fade" id="imgupload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><h4 class="modal-title" id="myModalLabel">Загрузка пикчи с компьютера <a href="http://imgur.com" target="_blank"><div class="imgur-logo"></div></a></h4></div><div class="modal-body"><div class="upload"><input type="file" id="image_selector" /></div><img src="" id="image_preview" /></div></div></div></div>');
    $("body").append('<div class="modal fade" id="js_image_container" style="text-align: center;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button><h4 class="modal-title" id="myModalLabel">КОРТИНКА</h4></div><div class="modal-body"><div class="cmds-content"></div></div></div></div></div>');
...
$("#newpollbtn").html('<span class="glyphicon glyphicon-poll"></span>').prop('title', 'САЗДАТЬ ОПРОС')
...
if (!ddg_444dgdgds4____) {
    ...
    hideVideoButton.innerHTML = "Скрыть видео";
    ...
    function toggleVideo() {
        if (!video.hided) {
            ...
            video.hided = !0;
            hideVideoButton.innerHTML = "Показать видео"
        } else {
    ...
    $('#emotelistbtn').remove();
    $('#leftcontrols').append(' <button id="emotesbtn" class="btn btn-sm btn-default">Смайлы</button>');
